...
- **Arjun** - *Initial work* - [@Arjun4522](https://github.com/Arjun4522)

---

## 🙏 Acknowledgments

- 🌟 Thanks to all contributors who have helped shape VANGUARD
- 📚 Special thanks to the open-source community for providing excellent tools and libraries
- 🎓 Inspired by cutting-edge research in federated learning and differential privacy
